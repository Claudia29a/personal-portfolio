...
export class ProjectsPageComponent {
    ...
    projectTexts: string[] = [
        ...
        'I also developed a media player app in Kotlin where users could listen to music, create libraries add/remove songs and search for certain playlists or songs. The application was designed, user tested and developed using Kotlin, Java.',
